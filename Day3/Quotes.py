...
second = "Yousuf"
result = first + " " + second
print(result)  # Output: AbbasAli Yousuf
...
print("Anu,\b Sha!") #\b backspace (output : Anu Sha!)
print("Anu,\tSha!")  #\t tab       (output : Anu,Sha!)
print("Anu, \"Sha!\"")#/           (output :Anu, "Sha!")
print("Anu,\\ Sha!")#/             (output : Anu, / Sha!)
...
names = ["hammad", "abbas ali", "hamza"]
names.append("aiman")  # Adding an item
print(names)  # Output: ['hamza', 'abbas ali', 'hammad',]
...
print(student["name"])  # Output: Abbas Ali
